<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("_obsRechazo");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid _obsRechazo");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: SolicitudPatenteComercial.ingresoObsRechazo
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">_obsRechazo</label>
                            		<div class="div_texbox">
                              		<input name="_obsRechazo" type="text" class="textbox" id="_obsRechazo" value="${_obsRechazo}" />
                            		</div>
