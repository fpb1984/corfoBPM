<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("_isPago");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid _isPago");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: PermisoEdificacion.GeneraPagoTCP
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">_isPago</label>
                            		<div class="div_checkbox">
                              		<input name="_isPago" type="checkbox" class="checkbox" id="_isPago" value="${_isPago}" />
                            		</div>
